...
% Match enumerate spacing
\usepackage{enumitem}
\setlist[enumerate]{itemsep=2pt,parsep=0pt,leftmargin=2em,labelindent=0.5em,align=left,labelwidth=1em,labelsep=0.5em}
\setlist[itemize]{itemsep=6pt,parsep=0pt,leftmargin=2em,labelindent=0.5em,align=left,labelwidth=1em,labelsep=0.5em}
